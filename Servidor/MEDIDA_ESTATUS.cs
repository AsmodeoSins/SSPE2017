...
namespace SSP.Servidor
{
    ...
    public partial class MEDIDA_ESTATUS
    {
        public MEDIDA_ESTATUS()
        {
            this.MEDIDA_MOTIVO = new HashSet<MEDIDA_MOTIVO>();
        ...
        public virtual ICollection<MEDIDA_MOTIVO> MEDIDA_MOTIVO { get; set; }
