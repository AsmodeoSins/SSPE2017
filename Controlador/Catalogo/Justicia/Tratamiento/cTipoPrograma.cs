...
{
    public class cTipoPrograma : EntityManagerServer<TIPO_PROGRAMA>
    {

        public cTipoPrograma() { }
        /// <summary>
        /// metodo que conecta con la base de datos para extraer todos los registros
        /// </summary>
        /// <returns>listado de tipo "TIPO_LUNAR"</returns>
        /// 
        public IQueryable<TIPO_PROGRAMA> ObtenerTodos()
        {
            try
            {
        ...
        public List<TIPO_PROGRAMA> ObtenerTodosLista(string buscar = "")
        {
            List<TIPO_PROGRAMA> etnias;
            var Resultado = new List<TIPO_PROGRAMA>();
            try
            {
        ...
        public List<TIPO_PROGRAMA> Obtener(int Id)
        {
            var Resultado = new List<TIPO_PROGRAMA>();
            try
            {
                Resultado = GetData().Where(w => w.ID_TIPO_PROGRAMA == Id).ToList();
            }
            catch (Exception ex)
            {
                throw new ApplicationException(ex.Message);
        ...
        public void Insertar(TIPO_PROGRAMA Entity)
        {
            try
            {
        ...
        public void Actualizar(TIPO_PROGRAMA Entity)
        {
            try
            {
                Update(Entity);
