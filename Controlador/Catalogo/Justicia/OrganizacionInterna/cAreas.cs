...
{
    public class cAreas : EntityManagerServer<AREA>
    {
        /// <summary>
        ...
        public IQueryable<AREA> ObtenerTodos(string buscar = "", short centro = 0)
        {
            try
            {
                getDbSet();
                ...
                else
                {
                    if (string.IsNullOrEmpty(buscar))
                        ...
                        return GetData().Where(w => w.ID_CENTRO == centro && w.DESCR.Contains(buscar));
                }
        ...
        public List<AREA> Obtener(short Id)
        {
        ...
        public void Insertar(AREA Entity)
        {
            try
            {
                ...
                Entity.ID_AREA = GetSequence<short>("AREA_SEQ");
                Insert(Entity);
            }
            catch (Exception ex)
            {
