...
{
    public class cEMIHPS : EntityManagerServer<EMI_HPS>
    {
        #region Constructor
        public cEMIHPS() { }
        #endregion
        ...
        public IQueryable<EMI_HPS> Obtener()
        {
            try
            {
                return GetData();
        ...
        public bool Agregar(EMI_HPS Entidad)
        {
            try
            {
                if (Insert(Entidad))
        ...
        public bool Actualizar(EMI_HPS Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_HPS Entidad)
        {
            try
            {
                if (Delete(Entidad))
