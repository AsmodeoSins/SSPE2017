...
{
    public class cEMIFactoresAbandono : EntityManagerServer<EMI_FACTORES_ABANDONO>
    {
        #region Constructor
        public cEMIFactoresAbandono() { }
        #endregion
        #region Obtener
        /// <summary>
        ...
        public IQueryable<EMI_FACTORES_ABANDONO> Obtener()
        {
            try
            {
                return GetData();
        ...
        public string Agregar(EMI_FACTORES_ABANDONO Entidad)
        {
            try
            {
        ...
        public string Actualizar(EMI_FACTORES_ABANDONO Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_FACTORES_ABANDONO Entidad)
        {
            try
            {
                if (Delete(Entidad))
