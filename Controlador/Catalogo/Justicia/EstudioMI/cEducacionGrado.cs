...
{
    public class cEducacionGrado : EntityManagerServer<EDUCACION_GRADO>
    {
        public cEducacionGrado() { }
        ...
        public IQueryable<EDUCACION_GRADO> Obtener()
        {
            try
            {
                return GetData();
        ...
        public EDUCACION_GRADO Obtener(int id)
        {
            try
            {
                return GetData(w=>w.ID_GRADO==id).SingleOrDefault();
            }
            catch (Exception ex)
            {
                throw new ApplicationException(ex.Message);
        ...
        public string Agregar(EDUCACION_GRADO Entidad)
        {
            try
            {
        ...
        public string Actualizar(EDUCACION_GRADO Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EDUCACION_GRADO Entidad)
        {
            try
            {
                if (Delete(Entidad))
