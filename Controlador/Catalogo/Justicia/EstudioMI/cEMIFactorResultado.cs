...
{
    public class cEMIFactorResultado : EntityManagerServer<EMI_FACTOR_RESULTADO>
    {
        #region Constructor
        public cEMIFactorResultado() { }
        #endregion
        #region Obtener
        /// <summary>
        ...
        public IQueryable<EMI_FACTOR_RESULTADO> Obtener()
        {
            try
            {
                return GetData();
        ...
        public string Agregar(EMI_FACTOR_RESULTADO Entidad)
        {
            try
            {
        ...
        public string Actualizar(EMI_FACTOR_RESULTADO Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_FACTOR_RESULTADO Entidad)
        {
            try
            {
                if (Delete(Entidad))
