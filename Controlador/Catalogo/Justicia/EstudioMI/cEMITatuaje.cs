...
{
    public class cEMITatuaje : EntityManagerServer<EMI_TATUAJE>
    {
        #region Constructor
        public cEMITatuaje() { }
        #endregion
        ...
        public IQueryable<EMI_TATUAJE> Obtener()
        {
            try
            {
                return GetData();
        ...
        public EMI_TATUAJE Obtener(int id)
        {
            try
            {
        ...
        public bool Agregar(EMI_TATUAJE Entidad)
        {
            try
            {
                if (Insert(Entidad))
        ...
        public bool Actualizar(EMI_TATUAJE Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_TATUAJE Entidad)
        {
            try
            {
                if (Delete(Entidad))
