...
{
    public class cEMISenasParticulares : EntityManagerServer<EMI_SENAS_PARTICULARES>
    {
        #region Constructor
        public cEMISenasParticulares() { }
        #endregion
        #region Obtener
        /// <summary>
        ...
        public IQueryable<EMI_SENAS_PARTICULARES> Obtener()
        {
            try
            {
                return GetData();
        ...
        public string Agregar(EMI_SENAS_PARTICULARES Entidad)
        {
            try
            {
        ...
        public string Actualizar(EMI_SENAS_PARTICULARES Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_SENAS_PARTICULARES Entidad)
        {
            try
            {
                if (Delete(Entidad))
