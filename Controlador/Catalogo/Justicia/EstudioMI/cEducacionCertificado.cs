...
{
    public class cEducacionCertificado : EntityManagerServer<EDUCACION_CERTIFICADO>
    {
        public cEducacionCertificado() { }
        ...
        public IQueryable<EDUCACION_CERTIFICADO> Obtener()
        {
            try
            {
                return GetData();
        ...
        public EDUCACION_CERTIFICADO Obtener(int id)
        {
            try
            {
                return GetData(w=>w.ID_CERTIFICADO==id).SingleOrDefault();
            }
            catch (Exception ex)
            {
                throw new ApplicationException(ex.Message);
        ...
        public string Agregar(EDUCACION_CERTIFICADO Entidad)
        {
            try
            {
        ...
        public string Actualizar(EDUCACION_CERTIFICADO Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EDUCACION_CERTIFICADO Entidad)
        {
            try
            {
                if (Delete(Entidad))
