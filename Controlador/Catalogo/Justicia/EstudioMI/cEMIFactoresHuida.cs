...
{
    public class cEMIFactoresHuida : EntityManagerServer<EMI_FACTORES_HUIDA>
    {
        #region Constructor
        public cEMIFactoresHuida() { }
        #endregion
        #region Obtener
        /// <summary>
        ...
        public IQueryable<EMI_FACTORES_HUIDA> Obtener()
        {
            try
            {
                return GetData();
        ...
        public string Agregar(EMI_FACTORES_HUIDA Entidad)
        {
            try
            {
        ...
        public string Actualizar(EMI_FACTORES_HUIDA Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_FACTORES_HUIDA Entidad)
        {
            try
            {
                if (Delete(Entidad))
