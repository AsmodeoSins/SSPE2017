...
{
    public class cEMIFactorNivel : EntityManagerServer<EMI_FACTOR_NIVEL>
    {
        #region Constructor
        public cEMIFactorNivel() { }
        #endregion
        #region Obtener
        /// <summary>
        ...
        public IQueryable<EMI_FACTOR_NIVEL> Obtener()
        {
            try
            {
                return GetData();
        ...
        public string Agregar(EMI_FACTOR_NIVEL Entidad)
        {
            try
            {
        ...
        public string Actualizar(EMI_FACTOR_NIVEL Entidad)
        {
            try
            {
                if (Update(Entidad))
        ...
        /// <returns>Cadena de texto con el resultado de la operación.</returns>
        public string Eliminar(EMI_FACTOR_NIVEL Entidad)
        {
            try
            {
                if (Delete(Entidad))
