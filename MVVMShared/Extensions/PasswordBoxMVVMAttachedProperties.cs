...
namespace MVVMShared.Extensiones
{
    public class PasswordBoxMVVMAttachedProperties
    {
        ...
        public static readonly DependencyProperty EncryptedPasswordProperty = DependencyProperty.RegisterAttached("EncryptedPassword",typeof(SecureString),
