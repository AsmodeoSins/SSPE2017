...
namespace ControlPenales
{
    partial class CatalogoPandillaViewModel
    {
        ...
        public string Ubicacion
        {
            ...
            set { _ubicacion = value; OnPropertyChanged("Ubicacion"); }
        }
        ...
        private PANDILLA _pandilla;
        public PANDILLA Pandilla
        {
            get { return _pandilla; }
            set { _pandilla = value; OnPropertyChanged("Pandilla"); }
        }

        private List<PANDILLA> _listItems;
        public List<PANDILLA> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private PANDILLA _selectedItem;
        public PANDILLA SelectedItem
        {
