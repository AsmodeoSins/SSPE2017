...
namespace ControlPenales
{
    partial class CatalogoAmparoIndirectoTipoViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_amparo_indirecto_tipo";
            }
        }
        ...
        private List<AMPARO_INDIRECTO_TIPO> _listItems;
        public List<AMPARO_INDIRECTO_TIPO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private AMPARO_INDIRECTO_TIPO _selectedItem;
        public AMPARO_INDIRECTO_TIPO SelectedItem
        {
