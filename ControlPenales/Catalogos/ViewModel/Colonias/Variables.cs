...
namespace ControlPenales
{
    partial class CatalogoColoniasViewModel
    {
        ...
        private bool _paisHabilitado;
        public bool PaisHabilitado
        {
            get { return _paisHabilitado; }
            set { _paisHabilitado = value; OnPropertyChanged("PaisHabilitado"); }
        }

        private bool _entidadHabilitado;
        public bool EntidadHabilitado
        {
            get { return _entidadHabilitado; }
            set { _entidadHabilitado = value; OnPropertyChanged("EntidadHabilitado"); }
        }
        ...
        private ObservableCollection<COLONIA> _listItems;
        ...
        private ObservableCollection<PAIS_NACIONALIDAD> _listPaises;
        public ObservableCollection<PAIS_NACIONALIDAD> ListPaises
        {
            get { return _listPaises; }
            set { _listPaises = value; OnPropertyChanged("ListPaises"); }
        }

        private ObservableCollection<ENTIDAD> _listEntidades;
        public ObservableCollection<ENTIDAD> ListEntidades
        {
            get { return _listEntidades; }
            set { _listEntidades = value; OnPropertyChanged("ListEntidades"); }
        }
        ...
        public ENTIDAD SelectedEntidad
        {
            ...
            set
            {
                ...
                ListMunicipios = new ObservableCollection<MUNICIPIO>(new cMunicipio().ObtenerTodos(""));
                ListMunicipios.Insert(0, new MUNICIPIO() { MUNICIPIO1 = "TODOS", ID_MUNICIPIO = 0 });
                SelectedMunicipio = ListMunicipios.Where(w => w.ID_ENTIDAD == 0).FirstOrDefault();
            }
        }

        private PAIS_NACIONALIDAD _selectedPais;
        public PAIS_NACIONALIDAD SelectedPais
        {
            ...
            set
            {
                ...
                ListEntidades = new ObservableCollection<ENTIDAD>(new cEntidad().ObtenerTodos(""));
                SelectedEntidad = ListEntidades.Where(w => w.ID_ENTIDAD == 2).FirstOrDefault();
            }
        }

        private COLONIA _selectedItem;
        public COLONIA SelectedItem
        {
