...
namespace ControlPenales
{
    partial class CatalogoTipoAutoridadViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_tipo_autoridad";
            }
        }
        ...
        private ObservableCollection<TIPO_AUTORIDAD_INTERNA> _listItems;
        public ObservableCollection<TIPO_AUTORIDAD_INTERNA> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_AUTORIDAD_INTERNA _selectedItem;
        public TIPO_AUTORIDAD_INTERNA SelectedItem
        {
