...
{
    partial class CatalogoAreaTrabajoViewModel : ValidationViewModelBase, IPageViewModel, IDataErrorInfo
    {
        public CatalogoAreaTrabajoViewModel()
        {
            EmptyVisible = false;
            //Listado 
            ListItems = new ObservableCollection<AREA_TRABAJO>();
            CatalogoHeader = "Áreas de Trabajo";
            HeaderAgregar = "Agregar Nueva Área de Trabajo";
            //LLENAR 
            EditarVisible = false;
            NuevoVisible = false;
        ...
        private async void clickSwitch(Object obj)
        {
            switch (obj.ToString())
            {
                ...
                case "menu_editar":
                    ...
                    {
                        HeaderAgregar = "Editar Área de Trabajo";
                        ...
                        FocusText = true;
                        /*****************************************/
                        Clave = SelectedItem.ID_AREA_EMP;
