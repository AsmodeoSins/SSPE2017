...
namespace ControlPenales
{
    partial class CatalogoAreaTrabajoViewModel
    {
        ...
        private ObservableCollection<AREA_TRABAJO> _listItems;
        public ObservableCollection<AREA_TRABAJO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private AREA_TRABAJO _selectedItem;
        public AREA_TRABAJO SelectedItem
        {
