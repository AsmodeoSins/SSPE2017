...
namespace ControlPenales
{
    partial class CatalogoEscolaridadViewModel
    {
        ...
        private List<ESCOLARIDAD> _listItems;
        public List<ESCOLARIDAD> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private ESCOLARIDAD _selectedItem;
        public ESCOLARIDAD SelectedItem
        {
