...
namespace ControlPenales
{
    partial class CatalogoPersonalidadMotivoViewModel
    {
        ...
        private List<PERSONALIDAD_MOTIVO> _listItems;
        public List<PERSONALIDAD_MOTIVO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private PERSONALIDAD_MOTIVO _selectedItem;
        public PERSONALIDAD_MOTIVO SelectedItem
        {
