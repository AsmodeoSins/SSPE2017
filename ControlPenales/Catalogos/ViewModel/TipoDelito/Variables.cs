...
namespace ControlPenales
{
    partial class CatalogoTipoDelitoViewModel
    {
        ...
        private List<TIPO_DELITO> _listItems;
        public List<TIPO_DELITO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_DELITO _selectedItem;
        public TIPO_DELITO SelectedItem
        {
