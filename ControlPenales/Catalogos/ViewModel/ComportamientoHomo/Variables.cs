...
namespace ControlPenales
{
    partial class CatalogoComportamientoHomoViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_comportamiento_homosexual";
            }
        }
        ...
        private ObservableCollection<COMPORTAMIENTO_HOMO> _listItems;
        public ObservableCollection<COMPORTAMIENTO_HOMO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private COMPORTAMIENTO_HOMO _selectedItem;
        public COMPORTAMIENTO_HOMO SelectedItem
        {
