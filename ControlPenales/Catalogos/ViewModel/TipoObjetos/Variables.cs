...
{
    partial class CatalogoTipoObjetosViewModel
    {
        ...
        private short? _configuracion;
        public short? Configuracion
        {
            get { return _configuracion; }
            set { _configuracion = value; OnPropertyChanged("Configuracion"); }
        }

        private int _maxLengthConfig;
        public int MaxLengthConfig
        {
            get { return _maxLengthConfig; }
            set { _maxLengthConfig = value; OnPropertyChanged("MaxLengthConfig"); }
        }
        ...
        private string permitido = "S";
        public string Permitido
        {
            get { return permitido; }
            set { permitido = value; OnPropertyChanged("Permitido"); }
        }
        ...
        public EstatusControl Lista_Estatus
        {
            ...
            set { _listEstatus = value; RaisePropertyChanged("Lista_Estatus"); }
        }

        private ControlPenales.Clases.Estatus.Estatus _selectedEstatus;
        ...
        private List<OBJETO_TIPO> _listItems;
        public List<OBJETO_TIPO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private OBJETO_TIPO _selectedItem;
        public OBJETO_TIPO SelectedItem
        {
