...
namespace ControlPenales
{
    partial class CatalogoTipoSangreViewModel
    {
        ...
        private List<TIPO_SANGRE> _listItems;
        public List<TIPO_SANGRE> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_SANGRE _selectedItem;
        public TIPO_SANGRE SelectedItem
        {
