...
namespace ControlPenales
{
    partial class CatalogoAmparoIncidenteTipoViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_amparo_incidente_tipo";
            }
        }
        ...
        private bool _aplicaCausaPenal = false;
        public bool AplicaCausaPenal
        {
            get { return _aplicaCausaPenal; }
            set { _aplicaCausaPenal = value; OnPropertyChanged("AplicaCausaPenal"); }
        }
        ...
        private List<AMPARO_INCIDENTE_TIPO> _listItems;
        public List<AMPARO_INCIDENTE_TIPO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private AMPARO_INCIDENTE_TIPO _selectedItem;
        public AMPARO_INCIDENTE_TIPO SelectedItem
        {
