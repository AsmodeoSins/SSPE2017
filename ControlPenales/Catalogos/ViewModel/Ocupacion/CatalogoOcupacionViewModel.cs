...
{
    partial class CatalogoOcupacionViewModel : ValidationViewModelBase, IPageViewModel, IDataErrorInfo
    {
        void IPageViewModel.inicializa() { }

        public CatalogoOcupacionViewModel()
        {
            EmptyVisible = false;
            //Listado 
            ListItems = new List<OCUPACION>();
            CatalogoHeader = "Ocupación";
            HeaderAgregar = "Agregar Ocupación";
            //LLENAR 
            EditarVisible = false;
            NuevoVisible = false;
        ...
        private async void ClickSwitch(Object obj)
        {
            switch (obj.ToString())
            {
                ...
                case "menu_editar":
                    ...
                    {
                        HeaderAgregar = "Editar Ocupación";
                        ...
                        FocusText = true;
                        /*****************************************/
                        Clave = SelectedItem.ID_OCUPACION;
        ...
        private void GetOcupacion()
        {
            //cOcupacion ocupacion = new cOcupacion();
            //ListItems.Clear();
            //ListItems = new ObservableCollection<OCUPACION>(ocupacion.ObtenerTodos(Busqueda));
            ...
            {
                ListItems.Clear();
                ListItems = new List<OCUPACION>(new cOcupacion().ObtenerTodos(Busqueda));
                if (ListItems.Count > 0)
                    EmptyVisible = false;
                else
                    EmptyVisible = true;
            ...
            {
                StaticSourcesViewModel.ShowMessageError("Algo pasó...", "Ocurrió un error al obtener tipos de ocupación.", ex);
            }
        }
        ...
        private void GuardarOcupacion()
        {
            try
            {
                ...
                if (Clave > 0)
                {
                    ...
                    ocupacion.Actualizar(new OCUPACION { ID_OCUPACION = Clave, DESCR = SelectedItem.DESCR, ESTATUS = SelectedEstatus.CLAVE });
                }
                else
                {   //Agregar
                    ocupacion.Insertar(new OCUPACION { ID_OCUPACION = Clave, DESCR = Descripcion, ESTATUS = SelectedEstatus.CLAVE });
                }
        ...
        private async void OcupacionLoad(CatalogoSimpleView obj)
        {
            try
            {
        ...
        private void ConfiguraPermisos()
        {
            try
            {
                var permisos = new cProcesoUsuario().Obtener(enumProcesos.CAT_OCUPACION.ToString(), StaticSourcesViewModel.UsuarioLogin.Username);
