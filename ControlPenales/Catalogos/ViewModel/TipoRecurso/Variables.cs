...
namespace ControlPenales
{
    partial class TipoRecursoViewModel
    {
        ...
        private string estatus = "S";
        public string Estatus
        {
            get { return estatus; }
            set { estatus = value; OnPropertyChanged("Estatus"); }
        }
        ...
        private List<TIPO_RECURSO> _listItems;
        public List<TIPO_RECURSO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_RECURSO _selectedItem;
        public TIPO_RECURSO SelectedItem
        {
