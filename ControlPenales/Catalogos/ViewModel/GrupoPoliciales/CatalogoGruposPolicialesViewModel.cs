...
namespace ControlPenales
{
    ...
    {
        cGrupoTactico grupotactico = new cGrupoTactico();
        ...
        private async void ClickSwitch(Object obj)
        {
            switch (obj.ToString())
            {
                ...
                case "menu_editar":
                    ...
                    {
                        HeaderAgregar = "Editar Grupos Policiales";
                        ...
                        FocusText = true;
                        /*****************************************/
                        Clave = SelectedItem.ID_GRUPO_TACTICO;
                    ...
                    break;
                case "menu_agregar":
                    HeaderAgregar = "Agregar Grupos Policiales";
                    #region visiblePantalla
                    EditarVisible = false;
                    NuevoVisible = true;
                    GuardarMenuEnabled = true;
        ...
        private void GetGruposPoliciales()
        {
            try
            {
                ListItems.Clear();
                ListItems = new ObservableCollection<GRUPO_TACTICO>(new cGrupoTactico().ObtenerTodos(Busqueda).ToList());
        ...
        private void GuardarGrupoPolciales()
        {
            try
            {
                if (Clave > 0)
                {  //Actualizar
                    ...
                    grupotactico.Actualizar(new GRUPO_TACTICO
                    {
                        ID_GRUPO_TACTICO = SelectedItem.ID_GRUPO_TACTICO,
                        DESCR = Descripcion,
                ...
                {   //Agregar
                    grupotactico.Insertar(new GRUPO_TACTICO
                    {
                        ID_GRUPO_TACTICO = Clave,
                        DESCR = Descripcion,
                        ESTATUS = SelectedEstatus.CLAVE
                    });
                }
        ...
        private bool EliminarTipoVisita()
        {
            try
            {
                if (SelectedItem != null || SelectedItem.ID_GRUPO_TACTICO >= 100)
                {
                    if (!grupotactico.Eliminar(SelectedItem.ID_GRUPO_TACTICO))
                        return false;
                    Clave = 0;
                    Descripcion = string.Empty;
                    Busqueda = string.Empty;
        ...
        private void ConfiguraPermisos()
        {
            try
            {
                var permisos = new cProcesoUsuario().Obtener(enumProcesos.CAT_GRUPOS_POLICIALES.ToString(), StaticSourcesViewModel.UsuarioLogin.Username);
