...
{
    partial class CatalogoReligionViewModel : ValidationViewModelBase, IPageViewModel, IDataErrorInfo
    {
        public CatalogoReligionViewModel()
        {
            EmptyVisible = false;
            //Listado 
            ListItems = new List<RELIGION>();
            CatalogoHeader = "Religión";
            HeaderAgregar = "Agregar Religión";
            //LLENAR 
            EditarVisible = false;
            NuevoVisible = false;
            ...
            switch (obj.ToString())
            {
                ...
                case "menu_editar":
                    if (SelectedItem != null)
                    {
                        ...
                        FocusText = true;
                        /*****************************************/
                        Clave = SelectedItem.ID_RELIGION;
        ...
        private void GetReligiones()
        {
            //cReligion religion = new cReligion();
            //ListItems.Clear();
            //ListItems = new ObservableCollection<RELIGION>(religion.ObtenerTodos(Busqueda));
            ...
            {
                ListItems.Clear();
                ListItems = new List<RELIGION>(new cReligion().ObtenerTodos(Busqueda));
                if (ListItems.Count > 0)
            ...
            {
                StaticSourcesViewModel.ShowMessageError("Algo pasó...", "Ocurrió un error al obtener tipos de religión.", ex);
            }
        }
        ...
        private void GuardarReligion()
        {
            try
            {
                ...
                if (Clave > 0)
                {
                    ...
                    religion.Actualizar(new RELIGION { ID_RELIGION = Clave, DESCR = SelectedItem.DESCR, ESTATUS = SelectedEstatus.CLAVE });
                }
                else
                {   //Agregar
                    religion.Insertar(new RELIGION { ID_RELIGION = Clave, DESCR = Descripcion, ESTATUS = SelectedEstatus.CLAVE });
                }
        ...
        private async void ReligionTipoLoad(CatalogoSimpleView obj)
        {
            try
            {
                await StaticSourcesViewModel.CargarDatosMetodoAsync(() =>
                {
                    ...
                    //Listado 
                    ListItems = new List<RELIGION>();
                    CatalogoHeader = "Tipo de Religión";
                    HeaderAgregar = "Agregar Tipo de Religión";
                    //LLENAR 
                    EditarVisible = false;
                    NuevoVisible = false;
                    AgregarVisible = false;
            ...
            {
                StaticSourcesViewModel.ShowMessageError("Algo pasó...", "Ocurrió un error al cargar tipo de religión.", ex);
            }
        }
        ...
        private void ConfiguraPermisos()
        {
            try
            {
                var permisos = new cProcesoUsuario().Obtener(enumProcesos.CAT_RELIGION.ToString(), StaticSourcesViewModel.UsuarioLogin.Username);
