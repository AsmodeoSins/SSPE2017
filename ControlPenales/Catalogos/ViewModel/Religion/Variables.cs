...
{
    partial class CatalogoReligionViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_religion";
            }
        }
        ...
        private List<RELIGION> _listItems;
        public List<RELIGION> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private RELIGION _selectedItem;
        public RELIGION SelectedItem
        {
