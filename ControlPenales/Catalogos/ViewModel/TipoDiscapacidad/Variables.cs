...
namespace ControlPenales
{
    partial class TipoDiscapacidadViewModel
    {
        ...
        private bool _huella = true;
        public bool Huella
        {
            get { return _huella; }
            set { _huella = value; OnPropertyChanged("Huella"); }
        }

        private string _estatus = "S";
        ...
        private List<TIPO_DISCAPACIDAD> _listItems;
        public List<TIPO_DISCAPACIDAD> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_DISCAPACIDAD _selectedItem;
        public TIPO_DISCAPACIDAD SelectedItem
        {
