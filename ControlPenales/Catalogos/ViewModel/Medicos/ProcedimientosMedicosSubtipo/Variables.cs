...
namespace ControlPenales
{
    partial class ProcedimientosSubtipoViewModel
    {
        ...
        private List<PROC_MED_SUBTIPO> _listItems;
        public List<PROC_MED_SUBTIPO> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private PROC_MED_SUBTIPO _selectedItem;
        public PROC_MED_SUBTIPO SelectedItem
        {
        ...
        private short _SelectTipoAtencion;
        public short SelectTipoAtencion
        {
            get { return _SelectTipoAtencion; }
            set { _SelectTipoAtencion = value; OnPropertyChanged("SelectTipoAtencion"); }
        }

        private ATENCION_TIPO _SelectTipoAtencionAgregar;
        public ATENCION_TIPO SelectTipoAtencionAgregar
        {
            get { return _SelectTipoAtencionAgregar; }
            set { _SelectTipoAtencionAgregar = value; OnPropertyChanged("SelectTipoAtencionAgregar"); }
        }
