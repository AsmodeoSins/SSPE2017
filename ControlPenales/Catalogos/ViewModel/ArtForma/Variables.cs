...
namespace ControlPenales
{
    partial class CatalogoArtFormaViewModel
    {
        ...
        private ObservableCollection<ART_FORMA> _listItems;
        public ObservableCollection<ART_FORMA> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private ART_FORMA _selectedItem;
        public ART_FORMA SelectedItem
        {
