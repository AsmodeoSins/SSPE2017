...
{
    partial class CatalogoTipoDefectoViewModel
    {
        public string Name
        {
            get
            {
                return "catalogo_tipo_defecto";
            }
        }
        ...
        private List<TIPO_DEFECTO> _listItems;
        public List<TIPO_DEFECTO> ListItems
        {
        ...
        private TIPO_DEFECTO _selectedItem;
        public TIPO_DEFECTO SelectedItem
        {
