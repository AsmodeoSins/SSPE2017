...
{
    partial class CatalogoTipoLunarViewModel
    {
        ...
        private List<TIPO_LUNAR> _listItems;
        public List<TIPO_LUNAR> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_LUNAR _selectedItem;
        public TIPO_LUNAR SelectedItem
        {
