...
namespace ControlPenales
{
    partial class CatalogoMediaFiliacionViewModel
    {
        ...
        public string Name
        {
            get
            {
                return "catalogo_media_filiacion";
            }
        }
        ...
        private List<MEDIA_FILIACION> _listItems;
        public List<MEDIA_FILIACION> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private MEDIA_FILIACION _selectedItem;
        public MEDIA_FILIACION SelectedItem
        {
