...
{
    partial class CatalogoTipoIngresoViewModel : ValidationViewModelBase, IPageViewModel, IDataErrorInfo
    {
        public CatalogoTipoIngresoViewModel()
        {
            EmptyVisible = false;
            //Listado 
            ListItems = new List<TIPO_INGRESO>();
            CatalogoHeader = "Tipo de Ingreso";
            HeaderAgregar = "Agregar Nuevo Tipo de Ingreso";
            //LLENAR 
            EditarVisible = false;
            NuevoVisible = false;
        ...
        private async void clickSwitch(Object obj)
        {
            switch (obj.ToString())
            {
                ...
                case "menu_editar":
                    ...
                    {
                        HeaderAgregar = "Editar Tipo de Ingreso";
                        ...
                        FocusText = true;
                        /*****************************************/
                        Clave = SelectedItem.ID_TIPO_INGRESO;
