...
namespace ControlPenales
{
    partial class CatalogoUnidadMedidaViewModel
    {
        ...
        public string Abreviatura
        {
            ...
            set { _abreviatura = value; OnPropertyChanged("Abreviatura"); }
        }

        private int _maxLengthAbreviatura;
        public int MaxLengthAbreviatura
        {
            get { return _maxLengthAbreviatura; }
            set { _maxLengthAbreviatura = value; OnPropertyChanged("MaxLengthAbreviatura"); }
        }
        ...
        private List<DROGA_UNIDAD_MEDIDA> _listItems;
        public List<DROGA_UNIDAD_MEDIDA> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private DROGA_UNIDAD_MEDIDA _selectedItem;
        public DROGA_UNIDAD_MEDIDA SelectedItem
        {
