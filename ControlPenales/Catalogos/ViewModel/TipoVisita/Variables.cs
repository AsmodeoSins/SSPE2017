...
namespace ControlPenales
{
    partial class CatalogoTipoVisitaViewModel
    {
        ...
        private ObservableCollection<TIPO_VISITA> _listItems;
        public ObservableCollection<TIPO_VISITA> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private TIPO_VISITA _selectedItem;
        public TIPO_VISITA SelectedItem
        {
