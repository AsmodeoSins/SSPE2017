...
namespace ControlPenales
{
    partial class CatalogoPaisesViewModel
    {
        ...
        private List<PAIS_NACIONALIDAD> _listItems;
        public List<PAIS_NACIONALIDAD> ListItems
        {
            get { return _listItems; }
            set { _listItems = value; OnPropertyChanged("ListItems"); }
        }

        private PAIS_NACIONALIDAD _selectedItem;
        public PAIS_NACIONALIDAD SelectedItem
        {
