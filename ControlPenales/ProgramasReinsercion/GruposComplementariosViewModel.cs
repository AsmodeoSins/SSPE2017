...
{
    class GruposComplementariosViewModel : ValidationViewModelBase, IPageViewModel
    {
        #region constructor
        public GruposComplementariosViewModel() 
        {
            SuspendidosTabName = "SUSPENDIDOS Y GRUPOS";
            CanceladosVisible = true;
        }
        #endregion
