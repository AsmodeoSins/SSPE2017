...
namespace ControlPenales.Clases
{
    public class CURPRFC
    {
        ...
        static public string CalcularRFC(string nombre, string apellidoPaterno, string apellidoMaterno, string fecha)
        {
            ...
            apellidoMaterno = string.IsNullOrWhiteSpace(apellidoMaterno) ? string.Empty : apellidoMaterno.ToUpper();
            ...
            apellidoMaterno = string.IsNullOrWhiteSpace(apellidoMaterno) ? string.Empty : apellidoMaterno.Trim();

            //Quitamos los artículos de los apellidos
            apellidoPaterno = QuitarArticulos(apellidoPaterno);
            apellidoMaterno =!string.IsNullOrWhiteSpace(apellidoMaterno)? QuitarArticulos(apellidoMaterno):string.Empty;
            ...
            if (string.IsNullOrEmpty(apellidoMaterno) ? true : apellidoMaterno.Trim() == string.Empty)
                apellidoMaterno = "X";
        ...
        static public string CalcularCURP(string nombre, string apellidoPaterno, string apellidoMaterno, string fecha)
        {
            //Cambiamos todo a mayúsculas
            nombre = nombre.ToUpper();
            
            apellidoPaterno = apellidoPaterno.ToUpper();
            apellidoMaterno = !string.IsNullOrWhiteSpace(apellidoMaterno)? apellidoMaterno.ToUpper():string.Empty;
            ...
            nombre.Trim();
            apellidoPaterno = apellidoPaterno.Trim();
            apellidoMaterno = !string.IsNullOrWhiteSpace(apellidoMaterno) ? apellidoMaterno.Trim() : string.Empty;
