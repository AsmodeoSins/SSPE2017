...
{
    public partial class ReporteControlVisitantesXDiaIntimaViewModel : ValidationViewModelBase
    {
        public async void OnLoad(ReporteControlVisitantesXDiaIntima Window)
        {
            try
            {
                ConfiguraPermisos();
        ...
        private void ConfiguraPermisos()
        {
            try
            {
                var permisos = new cProcesoUsuario().Obtener(enumProcesos.REPORTE_CONTROL_VISITANTES_INTIMOS_DIA.ToString(), StaticSourcesViewModel.UsuarioLogin.Username);
