...
{
    public partial class ReporteResponsableGruposViewModel : ValidationViewModelBase
    {

        #region Constructor
        public ReporteResponsableGruposViewModel() { }
        #endregion
        ...
        private async void OnLoad(ReporteResponsableGruposView Window = null)
        {
            try
            {
                ConfiguraPermisos();
        ...
        private void GenerarReporte()
        {
            try
            {
                ...
                #region Reporte
                Reporte.LocalReport.ReportPath = "Reportes/rResponsableGrupo.rdlc";
