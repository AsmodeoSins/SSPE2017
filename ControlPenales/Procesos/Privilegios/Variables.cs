...
namespace ControlPenales
{
    ...
    {
        #region Procesos
        private ObservableCollection<PROCESO> lstProcesos;
        public ObservableCollection<PROCESO> LstProcesos
        {
            get { return lstProcesos; }
            set { lstProcesos = value; OnPropertyChanged("LstProcesos"); }
        }

        private PROCESO selectedProceso;
        public PROCESO SelectedProceso
        {
            get { return selectedProceso; }
            set { selectedProceso = value; OnPropertyChanged("SelectedProceso"); }
        }
        ...
        public string PDescripcion
        {
            ...
            set { pDescripcion = value; OnPropertyChanged("PDescripcion"); }
        }

        private string pVentana;
        public string PVentana
        {
            get { return pVentana; }
            set { pVentana = value; OnPropertyChanged("PVentana"); }
        }
        

        private string bPDescripcion;
        public string BPDescripcion
        {
            get { return bPDescripcion; }
            set { bPDescripcion = value; OnPropertyChanged("BPDescripcion"); }
        }

        private string procesoTitulo = "Agregar Proceso";
        public string ProcesoTitulo
        {
            get { return procesoTitulo; }
            set { procesoTitulo = value; OnPropertyChanged("ProcesoTitulo"); }
        }

        private Visibility procesosVisible = Visibility.Visible;
        public Visibility ProcesosVisible
        {
            get { return procesosVisible; }
            set { procesosVisible = value; OnPropertyChanged("ProcesosVisible"); }
        }

        //BUSCAR EN POPUP
        private string bPUProceso;
        public string BPUProceso
        {
            get { return bPUProceso; }
            set { bPUProceso = value; OnPropertyChanged("BPUProceso"); }
        }

        private ObservableCollection<cProc> lstProcesoBuscar;
        public ObservableCollection<cProc> LstProcesoBuscar
        {
            get { return lstProcesoBuscar; }
            set { lstProcesoBuscar = value;
            if (value != null)
            {
                ProcesoUsuarioPopEmpty = value.Count > 0 ? Visibility.Collapsed : Visibility.Collapsed;
            }
            else
                ProcesoUsuarioPopEmpty = Visibility.Visible;

                OnPropertyChanged("LstProcesoBuscar"); }
        }

        private Visibility procesoUsuarioPopEmpty = Visibility.Visible;
        public Visibility ProcesoUsuarioPopEmpty
        {
            get { return procesoUsuarioPopEmpty; }
            set { procesoUsuarioPopEmpty = value; OnPropertyChanged("ProcesoUsuarioPopEmpty"); }
        }
        #endregion

        #region Roles
        private ObservableCollection<SISTEMA_ROL> lstRoles;
        public ObservableCollection<SISTEMA_ROL> LstRoles
        {
            get { return lstRoles; }
            set { lstRoles = value; OnPropertyChanged("LstRoles"); }
        }
        ...
        public SISTEMA_ROL SelectedRol
        {
            ...
            set { selectedRol = value;
                ObtenerTodoProcesoRol();
        ...
        {
            get { return rDescripcion; }
            set { rDescripcion = value; OnPropertyChanged("RDescripcion"); }
        }

        private string bRDescripcion;
        public string BRDescripcion
        {
            get { return bRDescripcion; }
            set { bRDescripcion = value; OnPropertyChanged("BRDescripcion"); }
        }

        private string rolTitulo = "Agregar Rol";
        public string RolTitulo
        {
            get { return rolTitulo; }
            set { rolTitulo = value; OnPropertyChanged("RolTitulo"); }
        }

        private Visibility rolesVisible = Visibility.Visible;
        public Visibility RolesVisible
        {
            get { return rolesVisible; }
            set { rolesVisible = value; OnPropertyChanged("RolesVisible"); }
        }
        #endregion

        #region Proceso Rol
        private ObservableCollection<cPermisosRol> lstPermisosRol;
        public ObservableCollection<cPermisosRol> LstPermisosRol
        {
            get { return lstPermisosRol; }
            set { lstPermisosRol = value; 
                OnPropertyChanged("LstPermisosRol"); }
        }

        private cPermisosRol selectedPermisoRol;
        public cPermisosRol SelectedPermisoRol
        {
            get { return selectedPermisoRol; }
            set { 
                selectedPermisoRol = value;
                OnPropertyChanged("SelectedPermisoRol");
            }
        }

        private Visibility permisoRolVisible = Visibility.Visible;
        public Visibility PermisoRolVisible
        {
            get { return permisoRolVisible; }
            set { 
                permisoRolVisible = value;
                OnPropertyChanged("PermisoRolVisible"); }
        }
        #endregion
        ...
        private short? selectedCentro = -1;
        ...
        #region Usuario Rol
        private ObservableCollection<cUsrRol> lstUsuarioRol;
        public ObservableCollection<cUsrRol> LstUsuarioRol
        {
            get { return lstUsuarioRol; }
            set { lstUsuarioRol = value; OnPropertyChanged("LstUsuarioRol"); }
        }

        private cUsrRol selectedUsuarioRol;
        public cUsrRol SelectedUsuarioRol
        {
            get { return selectedUsuarioRol; }
            set { selectedUsuarioRol = value;
                //ObtenerTodoUsuarioProceso();
                OnPropertyChanged("SelectedUsuarioRol"); }
        }

        private Visibility usuarioRolVisible = Visibility.Visible;
        public Visibility UsuarioRolVisible
        {
            get { return usuarioRolVisible; }
            set { usuarioRolVisible = value; 
                OnPropertyChanged("UsuarioRolVisible"); }
        }
        #endregion

        #region Usuario Proceso
        private ObservableCollection<cProcesoUsr> lstProcesoUsuario;
        public ObservableCollection<cProcesoUsr> LstProcesoUsuario
        {
            get { return lstProcesoUsuario; }
            set { lstProcesoUsuario = value;
            if (value != null)
            {
                UsuarioProcesoVisible = value.Count > 0 ? Visibility.Collapsed : Visibility.Visible;
            }
            else
                UsuarioProcesoVisible = Visibility.Visible;
                OnPropertyChanged("LstProcesoUsuario"); }
        }

        private cProcesoUsr selectedProcesoUsuario;
        public cProcesoUsr SelectedProcesoUsuario
        {
            get { return selectedProcesoUsuario; }
            set { selectedProcesoUsuario = value; 
                OnPropertyChanged("SelectedProcesoUsuario"); }
        }

        private Visibility usuarioProcesoVisible = Visibility.Visible;
        public Visibility UsuarioProcesoVisible
        {
            get { return usuarioProcesoVisible; }
            set { usuarioProcesoVisible = value; OnPropertyChanged("UsuarioProcesoVisible"); }
        }
        #endregion
        ...
        private bool bEditar = true;
        public bool BEditar
        {
            get { return bEditar; }
            set { bEditar = value; OnPropertyChanged("BEditar"); }
        }
        #endregion
