    ...
    partial class EntrevistaMultidiciplinariaViewModel
    {
        void setValidacionesFichaIdentificacion()
        {
            try
            {
                ...
                base.AddRule(() => FechaCaptura, () => FechaCaptura.HasValue ? FechaCaptura.Value.Date <= Fechas.GetFechaDateServer.Date ? true : false : false, FechaCaptura.HasValue ? "FECHA DE CAPTURA ES REQUERIDO PARA GRABAR" : "LA FECHA SELECCIONADA DEBE SER MENOR O IGUAL AL DIA DE HOY");
                ...
                OnPropertyChanged("FechaCaptura");
