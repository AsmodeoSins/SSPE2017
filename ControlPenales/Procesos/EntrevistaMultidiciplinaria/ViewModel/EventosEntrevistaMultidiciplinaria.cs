...
namespace ControlPenales
{
    partial class EntrevistaMultidiciplinariaViewModel
    {
        ...
        {
            get { return new DelegateCommand<EntrevistaMultidiciplinariaView>(Load_Window); }
        }
        ...
        {
            get { return new DelegateCommand<IngresoAnteriorCereso>(IngresoAnteriorLoad); }
        }

        public ICommand IngresoAnteriorMenorLoading
        {
            get { return new DelegateCommand<IngresoAnteriorCeresoMenor>(IngresoAnteriorMenorLoad); }
        }
        ...
        {
            get { return new DelegateCommand<DatosGrupoFamiliar>(DatosGrupoFamiliarLoad); }
        }
        ...
        {
            get { return new DelegateCommand<ConductaParasocial>(ConductaParasocialLoad); }
        }
        ...
        {
            get { return new DelegateCommand<IngresoAnteriorCereso>(IngresoAnteriorUnload); }
        }

        public ICommand IngresoAnteriorMenorUnloading
        {
            get { return new DelegateCommand<IngresoAnteriorCeresoMenor>(IngresoAnteriorMenorUnload); }
        }
        ...
        {
            get { return new DelegateCommand<SituacionJuridica>(SituacionJuridicaUnload); }
        }
        ...
        {
            get { return new DelegateCommand<DatosGrupoFamiliar>(DatosGrupoFamiliarUnload); }
        }
        ...
        {
            get { return new DelegateCommand<FactoresSocioFamiliares>(FactoresSocioFamiliaresUnload); }
        }
        #endregion
