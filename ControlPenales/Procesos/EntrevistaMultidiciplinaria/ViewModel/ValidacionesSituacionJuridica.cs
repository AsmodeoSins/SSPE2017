...
namespace ControlPenales
{
    partial class EntrevistaMultidiciplinariaViewModel
    {
        ...
        void setValidacionesIngresosAnterioresPop()
        {
            ...
            {
                base.ClearRules();
                base.AddRule(() => SelectedEmisorIngreso, () => SelectedEmisorIngreso != null ? SelectedEmisorIngreso.ID_EMISOR != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                ...
                base.AddRule(() => PeriodoReclusionIngreso, () => string.IsNullOrEmpty(PeriodoReclusionIngreso) == false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                base.AddRule(() => DelitoDescripcion, () => string.IsNullOrEmpty(DelitoDescripcion) == false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                base.AddRule(() => SancionesIngreso, () => string.IsNullOrEmpty(SancionesIngreso) == false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
        ...
        void setValidacionesFamiliarDelitoPop()
        {
            ...
            {//Se comenta el campo de anio en base a requerimiento
                base.ClearRules();
                base.AddRule(() => SelectedParentescoFDel, () => SelectedParentescoFDel != null ? SelectedParentescoFDel.ID_TIPO_REFERENCIA != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                ...
                base.AddRule(() => SelectedEmisorFDel, () => SelectedEmisorFDel != null ? SelectedEmisorFDel.ID_EMISOR != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                ...
                base.AddRule(() => SelectedRelacionFDel, () => SelectedRelacionFDel != null ? SelectedRelacionFDel.ID_RELACION != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                base.AddRule(() => DelitoFDel, () => string.IsNullOrEmpty(DelitoFDel) == false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
        ...
        void setValidacionesFamiliarDrogaPop()
        {
            ...
            {//Se comenta el campo de anio en base a requerimiento
                base.ClearRules();
                base.AddRule(() => SelectedParentescoFDroga, () => SelectedParentescoFDroga != null ? SelectedParentescoFDroga.ID_TIPO_REFERENCIA != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                ...
                base.AddRule(() => SelectedDrogaFDroga, () => SelectedDrogaFDroga != null ? SelectedDrogaFDroga.ID_DROGA != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
                base.AddRule(() => SelectedRelacionFDroga, () => SelectedRelacionFDroga != null ? SelectedRelacionFDroga.ID_RELACION != -1 : false, "ESTE CAMPO ES REQUERIDO PARA GRABAR");
