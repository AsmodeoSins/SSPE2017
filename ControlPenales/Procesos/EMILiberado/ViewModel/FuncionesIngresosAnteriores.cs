...
namespace ControlPenales
{
    partial class EMILiberadoViewModel : ValidationViewModelBase
    {
        ...
        private void IngresoAnteriorLoad(IngresoAnteriorCeresoLiberado Window = null)
        {
            try
            {
        ...
        private void IngresoAnteriorMenorLoad(IngresoAnteriorCeresoMenorLiberado Window = null)
        {
            try
            {
                if (TabSituacionJuridicaSelected)//LA OPCION ESTA SELECCIONADA
        ...
        private void IngresoAnteriorUnload(IngresoAnteriorCeresoLiberado Window = null)
        {
            try
            {
                if (!base.HasErrors)
        ...
        private void IngresoAnteriorMenorUnload(IngresoAnteriorCeresoMenorLiberado Window = null)
        {
            try
            {
                if (!base.HasErrors)
        ...
        private void SituacionJuridicaUnload(SituacionJuridicaLiberacionView Window = null)
        {
            try
            {
                //switch (IndexMenu)+
        ...
        private void FactoresSocioFamiliaresUnload(FactoresSocioFamiliaresLiberado Window = null)
        {
            try
            {
