...
namespace ControlPenales
{
    partial class EMILiberadoViewModel
    {
        ...
        private ObservableCollection<DROGA_FRECUENCIA> lstFrecuenciasUsoDrogas;
        ...
        {
            get { return lstFrecuenciasUsoDrogas; }
            set
            {
                lstFrecuenciasUsoDrogas = value;
        ...
        public DateTime? popUpFechaUltDosis
        {
            get
            {
                return _popUpFechaUltDosis;
            }
            set
            {
                _popUpFechaUltDosis = value;
            ...
            set
            {
                ...
                if (value != null)
                {
                    if (value.Equals("S"))
                    {
                        ...
                        //VIHHepatitisDiagnosticoFormal = EMI_ENFERMEDAD.DIAGNOSTICO_FORMAL;
                        //VIHHepatitisTratamientoFarmaco = EMI_ENFERMEDAD.EN_TRATAMIENTO_FARMACO;
                    }
                    else
                    {
                        EnfermedadEnabled = false;
                        //var val = string.IsNullOrEmpty(value) ? null : value.ToString();
                        //VIHHepatitisTratamientoFarmaco = "" + val;
                        //VIHHepatitisDiagnosticoFormal = "" + val;
                    }
