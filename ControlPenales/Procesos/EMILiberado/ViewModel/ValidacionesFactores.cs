    ...
    partial class EMILiberadoViewModel
    {
        void setValidacionesFactores()
        {
            try
            {
                ...
                base.AddRule(() => PadresVivenJuntos, () => !string.IsNullOrEmpty(PadresVivenJuntos), "RECIBE VISITA ES REQUERIDO PARA GRABAR");
                ...
                base.AddRule(() => ApoyoEconomico, () => !string.IsNullOrEmpty(ApoyoEconomico), "APOYO ECONOMICO ES REQUERIDO PARA GRABAR");
                ...
                if (VivePadre != null)
                    if (VivePadre == "N")
                    {
                        base.AddRule(() => FallecioPadre, () => FallecioPadre.HasValue ? FallecioPadre <= new Fechas().CalculaEdad(SelectExpediente.NACIMIENTO_FECHA) :
                ...
                if (ViveMadre != null)
                    if (ViveMadre == "N")
                    {
                        base.AddRule(() => FallecioMadre, () => FallecioMadre.HasValue ? FallecioMadre <= new Fechas().CalculaEdad(SelectExpediente.NACIMIENTO_FECHA) : false, "LA EDAD ES MAYOR A LA ACTUAL");
                ...
                if (PadresVivenJuntos != null)
                    ...
                    {
                        base.AddRule(() => EdadInternoSeparacionPadres, () => EdadInternoSeparacionPadres.HasValue ? EdadInternoSeparacionPadres <= new Fechas().CalculaEdad(SelectExpediente.NACIMIENTO_FECHA) : false, "LA EDAD ES MAYOR A LA ACTUAL");
