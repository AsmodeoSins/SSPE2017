    ...
    partial class EMILiberadoViewModel
    {
        ...
        public short? FallecioPadre
        {
            ...
            set
            {
                ...
                if (SelectExpediente.NACIMIENTO_FECHA != null)
                    if (value <= ((Fechas.GetFechaDateServer - SelectExpediente.NACIMIENTO_FECHA.Value).Days / 365))
                    //if (value <= ((DateTime.Now - SelectedPersona.FEC_NACIMIENTO.Value).Days / 365))
                {
