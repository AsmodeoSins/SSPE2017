        ...
        private void GuardarFactorCrimidiagnostico()
        {
            try
            {
                ...
                if (emiActual != null)
                {
                    ...
                    {
                        var emi = new EMI() { ID_EMI = emiActual.ID_EMI, ID_EMI_CONS = emiActual.ID_EMI_CONS, ESTATUS = "C" };
            ...
            try
            {
                ...
                if (emiActual != null)
                    if (emiActual.EMI_CLAS_CRIMINOLOGICA != null)
                    {
                        ...
                        PertenenciaCrimenOrganizado = emiActual.EMI_CLAS_CRIMINOLOGICA.ID_CRIMENO;
                        ClasificacionCriminologica = emiActual.EMI_CLAS_CRIMINOLOGICA.ID_CLAS;
                ...
                if (AnteriorEMI != null)
                    ...
                    {
                        PertenenciaCrimenOrganizado = AnteriorEMI.EMI_CLAS_CRIMINOLOGICA.ID_CRIMENO;
                        ClasificacionCriminologica = AnteriorEMI.EMI_CLAS_CRIMINOLOGICA.ID_CLAS;
