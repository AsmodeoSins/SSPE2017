            ...
            try
            {
                ...
                if (emiActual != null)
                    if (emiActual.EMI_ENFERMEDAD != null)
                    {
                        ...
                        DescripcionPresentarlasAntecedentes = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.DESCR_ENFERMEDAD) ? string.Empty : emiActual.EMI_ENFERMEDAD.DESCR_ENFERMEDAD;
                        AparienciaFisicaAlineado = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.APFISICA_ALINADO) ? string.Empty : emiActual.EMI_ENFERMEDAD.APFISICA_ALINADO;
                        AparienciaFisicaConformado = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.APFISICA_CONFORMADO) ? string.Empty : emiActual.EMI_ENFERMEDAD.APFISICA_CONFORMADO;
                        AparienciaFisicaIntegro = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.APFISICA_INTEGRO) ? string.Empty : emiActual.EMI_ENFERMEDAD.APFISICA_INTEGRO;
                        AparienciaFisicaLimpio = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.APFISICA_LIMPIO) ? string.Empty :  emiActual.EMI_ENFERMEDAD.APFISICA_LIMPIO;
                        Discapacidades = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.DISCAPACIDAD) ? string.Empty : emiActual.EMI_ENFERMEDAD.DISCAPACIDAD;
                        DiscapacidadesMotivo = emiActual.EMI_ENFERMEDAD.DESCR_DISCAPACIDAD;
                        EnfermoMental = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.ENFERMO_MENTAL) ? string.Empty : emiActual.EMI_ENFERMEDAD.ENFERMO_MENTAL;
                        EnfermoMentalMotivo = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.DESCR_ENFERMO_MENTAL) ? string.Empty : emiActual.EMI_ENFERMEDAD.ENFERMO_MENTAL;
                        VIHHepatitis = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.VIH_HEPATITIS) ? string.Empty : emiActual.EMI_ENFERMEDAD.VIH_HEPATITIS;
                        VIHHepatitisTratamientoFarmaco = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.EN_TRATAMIENTO_FARMACO) ? string.Empty : emiActual.EMI_ENFERMEDAD.EN_TRATAMIENTO_FARMACO;
                        VIHHepatitisDiagnosticoFormal = string.IsNullOrEmpty(emiActual.EMI_ENFERMEDAD.DIAGNOSTICO_FORMAL) ? string.Empty : emiActual.EMI_ENFERMEDAD.DIAGNOSTICO_FORMAL;
                        return;
                    }
