...
namespace ControlPenales
{
    partial class EMILiberadoViewModel : ValidationViewModelBase
    {
        ...
        #region [LOAD]
        private void DatosGrupoFamiliarLoad(DatosGrupoFamiliarLiberado Window = null)
        {
            try
            {
        ...
        #endregion
        private void DatosGrupoFamiliarUnload(DatosGrupoFamiliarLiberado Window = null)
        {
            try
            {
