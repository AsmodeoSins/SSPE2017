namespace ControlPenales
{
    partial class NotificacionTrabajoSocialViewModel
    {
        ...
        public System.Windows.Input.ICommand NotificacionTrabajoSocialLoading
        {
            get { return new DelegateCommand<NotificacionTrabajoSocialView>(LoadNotificacionTrabajoSocial); }
        }

        public System.Windows.Input.ICommand CapturaNotificacionTrabajoSocialLoading
        {
            get { return new DelegateCommand<CapturaNotificacionView>(LoadCapturaNotificacionTS); }
        }
