...
namespace ControlPenales
{
    partial class AgendaMedicaViewModel
    {
        ...
        public void setBuscarAgendaValidacionRules()
        {
            ...
            base.AddRule(() => SelectedAtencionTipo, () => SelectedAtencionTipo!=-1,"EL TIPO DE ATENCION ES REQUERIDO!");
        ...
        {
            base.ClearRules();
            base.AddRule(() => SelectedBusquedaAgendaAtencionTipo, () => SelectedBusquedaAgendaAtencionTipo != -1, "EL TIPO DE ATENCION ES REQUERIDO!");
