...
namespace ControlPenales
{
    partial class JuridicoIdentificacionViewModel
    {
        ...
        public ObservableCollection<ALIAS> ListAlias
        {
            ...
            {
                listAlias = value;
                OnPropertyValidateChanged("ListAlias");
            }
        }
        ...
        public ObservableCollection<APODO> ListApodo
        {
            ...
            {
                listApodo = value;
                OnPropertyValidateChanged("ListApodo");
            }
        }
        ...
        public ObservableCollection<RELACION_PERSONAL_INTERNO> ListRelacionPersonalInterno
        {
            ...
            set { listRelacionPersonalInterno = value; 
                  OnPropertyValidateChanged("ListRelacionPersonalInterno"); }
        }
        ...
        public RELACION_PERSONAL_INTERNO SelectRelacionPersonalInterno
        {
            ...
            set { selectRelacionPersonalInterno = value; OnPropertyChanged("SelectRelacionPersonalInterno"); }
        }
        ...
        public RangeEnabledObservableCollection<INGRESO> ListBuscarRelacionInterno
        {
            ...
            set { listBuscarRelacionInterno = value; OnPropertyChanged("ListBuscarRelacionInterno"); }
        }

        private bool RISeguirCargando = true;

        private int RIPagina = 1;
