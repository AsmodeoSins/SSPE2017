...
namespace ControlPenales
{
    partial class JuridicoIdentificacionViewModel
    {
        ...
        public short? SelectedDialecto
        {
            ...
            set { selectedDialecto = value;
                  ChecarValidaciones();
                  OnPropertyValidateChanged("SelectedDialecto"); }
        }
        ...
        public bool RequiereTraductor
        {
            ...
            set { requiereTraductor = value;
                 ChecarValidaciones();
                 OnPropertyChanged("RequiereTraductor"); }
        }
        ...
        public short? SelectedIdioma
        {
            ...
            set { selectedIdioma = value;
                ChecarValidaciones();
                OnPropertyValidateChanged("SelectedIdioma"); }
        }
        #endregion
        ...
        public short? SelectMunicipio
        {
            ...
            set
            {
                ...
                if (selectMunicipio > 0)
                    llenarColonias(value, SelectEntidad);
                else
        ...
        public short? SelectEntidadNacimiento
        {
            ...
            set
            {
                ...
                if (selectEntidadNacimiento > 0)
                    llenarMunicipiosNacimiento(value);
                else
        ...
        public short? SelectEntidadDomicilioPadre
        {
            ...
            set
            {
                ...
                if (selectEntidadDomicilioPadre > 0)
                    llenarMunicipiosDomicilioPadre(value);
                else
        ...
        public short? SelectMunicipioDomicilioPadre
        {
            ...
            set
            {
                ...
                if (selectMunicipioDomicilioPadre > 0)
                    llenarColoniasDomicilioPadre(value);
                else
        ...
        public async void llenarEntidadesDomicilioPadre()
        {
            ListEntidadDomicilioPadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<ENTIDAD>>(() => new ObservableCollection<ENTIDAD>(new cEntidad().ObtenerTodos().OrderBy(o => o.DESCR)));
        }
        public async void llenarMunicipiosDomicilioPadre(short? entidad)
        {
            ListMunicipioDomicilioPadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<MUNICIPIO>>(() =>
                new ObservableCollection<MUNICIPIO>((new cMunicipio()).ObtenerTodos(string.Empty, entidad).OrderBy(o => o.MUNICIPIO1)));
        }
        public async void llenarColoniasDomicilioPadre(short? municipio)
        {
            ListColoniaDomicilioPadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<COLONIA>>(() =>
                new ObservableCollection<COLONIA>((new cColonia()).ObtenerTodos(string.Empty, municipio).OrderBy(o => o.DESCR)));
        }
        ...
        public bool MismoDomicilioPadre
        {
            ...
            set
            {
                ...
                ChecarValidaciones();
                //OnPropertyChanged("");
                OnPropertyValidateChanged("MismoDomicilioPadre");
            }
        }
        ...
        public bool MismoDomicilioPadreEnabled
        {
            ...
            set { mismoDomicilioPadreEnabled = value; 
                 OnPropertyChanged("MismoDomicilioPadreEnabled"); }
        }
        #endregion
        #endregion
        ...
        public short? SelectEntidadDomicilioMadre
        {
            ...
            set
            {
                ...
                if (selectEntidadDomicilioMadre > 0)
                    llenarMunicipiosDomicilioMadre(value);
                else
        ...
        public short? SelectMunicipioDomicilioMadre
        {
            ...
            set
            {
                ...
                if (selectMunicipioDomicilioMadre > 0)
                    llenarColoniasDomicilioMadre(value);
                else
        ...
        public async void llenarEntidadesDomicilioMadre()
        {
            ListEntidadDomicilioMadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<ENTIDAD>>(() =>
                new ObservableCollection<ENTIDAD>((new cEntidad()).ObtenerTodos().OrderBy(o => o.DESCR)));
        }
        public async void llenarMunicipiosDomicilioMadre(short? entidad)
        {
            ListMunicipioDomicilioMadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<MUNICIPIO>>(() =>
                new ObservableCollection<MUNICIPIO>((new cMunicipio()).ObtenerTodos(string.Empty, entidad).OrderBy(o => o.MUNICIPIO1)));
        }
        public async void llenarColoniasDomicilioMadre(short? municipio)
        {
            ListColoniaDomicilioMadre = await StaticSourcesViewModel.CargarDatos<ObservableCollection<COLONIA>>(() =>
                new ObservableCollection<COLONIA>((new cColonia()).ObtenerTodos(string.Empty, municipio).OrderBy(o => o.DESCR)));
        }
        #endregion
